import json
# Note: KiteException is handled in the backend kite_service
# This frontend service should not import broker-specific exceptions directly
...
class PortfolioService:
    def fetch_and_store_portfolio(self, user_id: str):
        ...
        try:
            ...
            logger.error(f"Broker API error fetching portfolio for {user_id}: {e}")
            raise
        except Exception as e:
