#!/usr/bin/env python3
t script to verify FastAPI and Pydantic imports work correctly
"""
import sys
import os
...
def test_imports():
    ...
    try:
        import pydantic
        print(fPydantic imported successfully: {pydantic.__version__}")
    except ImportError as e:
    ...
    try:
        ...
        print(fApp config import failed: {e}")
        return False
